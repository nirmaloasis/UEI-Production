 ...
 * @author NIRMAL
 */
public class Add_new_partsController implements Initializable {
    ...
    dbcon db=new dbcon();
    @FXML
    TextField p_number,p_name,g_number,amt_r;
    @FXML
    public void action_add()
    {
        String sql_querry = "INSERT INTO partsdb (item_code,item_name,group_no,no_required) VALUES ('"+p_number.getText()+"','"+p_name.getText()+"' , '"+g_number.getText()+"','"+amt_r.getText()+"')";
